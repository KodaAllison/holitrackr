...
export const canonicalCountryMetadata: Readonly<Record<string, CanonicalCountryMetadata>> = {
  ...
  BRN: { alpha2: "BN", name: "Brunei Darussalam" },
  ...
  CHN: { alpha2: "CN", name: "People's Republic of China" },
  CIV: { alpha2: "CI", name: "Cote d'Ivoire" },
  ...
  FLK: { alpha2: "FK", name: "Falkland Islands (Malvinas)" },
  FRA: { alpha2: "FR", name: "France" },
  FRO: { alpha2: "FO", name: "Faroe Islands" },
  FSM: { alpha2: "FM", name: "Micronesia, Federated States of" },
  ...
  GMB: { alpha2: "GM", name: "Republic of The Gambia" },
  ...
  IRN: { alpha2: "IR", name: "Islamic Republic of Iran" },
  ...
  LAO: { alpha2: "LA", name: "Lao People's Democratic Republic" },
  ...
  PSE: { alpha2: "PS", name: "State of Palestine" },
  PYF: { alpha2: "PF", name: "French Polynesia" },
  QAT: { alpha2: "QA", name: "Qatar" },
  REU: { alpha2: "RE", name: "Reunion" },
  ROU: { alpha2: "RO", name: "Romania" },
  RUS: { alpha2: "RU", name: "Russian Federation" },
  ...
  SXM: { alpha2: "SX", name: "Sint Maarten (Dutch part)" },
  SYC: { alpha2: "SC", name: "Seychelles" },
  SYR: { alpha2: "SY", name: "Syrian Arab Republic" },
  ...
  TUR: { alpha2: "TR", name: "Türkiye" },
  TUV: { alpha2: "TV", name: "Tuvalu" },
  TWN: { alpha2: "TW", name: "Taiwan, Province of China" },
  TZA: { alpha2: "TZ", name: "United Republic of Tanzania" },
  ...
  VAT: { alpha2: "VA", name: "Holy See (Vatican City State)" },
...
export function isKnownContinent(value: Continent | 'Other'): value is Continent {
  return value !== 'Other'
}
